...
* Date              : Date: 2005-7-19
* Updated by        : Author: Yonghui Hu
* Date              : Date: 2015-1-5
* Updated by        : Author: shougang wang
*
* Support mail      : www_wsg@163.com
*
...
{
    TWBR = TWI_TWBR;                    //*设置波特率，当处于主机模式时，用来产生SCL引脚上的时钟信号
                                        // Set bit rate register (Baudrate). Defined in header file.
                                        // Not used. Driver presumes prescaler to be 00.
    TWDR = 0xFF;                        //*默认值
...
void TWI_Start_Transceiver_With_Data( unsigned char *msg, unsigned char msgSize )
{
 ...
 // Number of data to transmit.
  ...
  {
    for (INT8U temp = 1; temp < msgSize; temp++ )
	{ 
...
application.
****************************************************************************/
//extern INT8U Speed_tem_z(EX_SPEED);
...
void TWI_ISR_Handler(void)
{
    ...
    switch (TWSR)
    {
        ...
        case TWI_MTX_DATA_NACK:     // Data byte has been tramsmitted and NACK received
          // No relevant state information available; TWINT = ??
